#
#  Be sure to run `pod spec lint CRProductTour.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "CRProductTour"
  s.version      = "0.0.2"
  s.summary      = "A bubble tutorial to help the user understand your interface. (The same of Garaband help system)"
  ...
  s.homepage     = "https://github.com/Cclleemm/ProductTour"
  # s.screenshots  = "raw.github.com/Cclleemm/ProductTour/master/screenshots/ProductTour.gif?raw=true"
...
s.source       = { :git => "https://github.com/paulrolfe/ProductTour.git", :tag => "0.0.1" }
